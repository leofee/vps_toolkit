...
submit_to_public_repo() {
  ...
  TMP_DIR=$(mktemp -d)
  REPO_URL="https://github.com/leofee/vps-toolkit-scripts.git"
  cd "$TMP_DIR" || return
  git init
  ...
  git push "https://$username:$token@github.com/leofee/vps-toolkit-scripts.git" master

  echo "✅ 已提交到公共仓库：https://github.com/leofee/vps-toolkit-scripts/tree/master/$username"
...
restore_from_public_repo() {
  ...
  url="https://raw.githubusercontent.com/leofee/vps-toolkit-scripts/master/$username/test_scripts.list"
  echo "🌐 正在拉取：$url"
